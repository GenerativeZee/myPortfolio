      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 left-4 md:bottom-8 md:right-8 md:left-auto z-50 md:w-[400px] h-[500px] max-h-[calc(100dvh-5rem)] flex flex-col glass rounded-2xl border border-white/[0.08] shadow-2xl shadow-black/50 overflow-hidden bg-[#0a0a0f]/95 backdrop-blur-xl"
          >
            {/* Header */}
            ...
            <div className="p-4 border-t border-white/[0.08] bg-white/[0.02]">
              <form onSubmit={handleSend} className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-white/[0.05] border border-white/[0.08] rounded-full pl-4 pr-12 py-3 text-base md:text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-indigo-500/50 focus:bg-white/[0.08] transition-all"
                />
                <button
                  type="submit"
