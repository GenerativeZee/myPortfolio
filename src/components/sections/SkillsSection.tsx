...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      "SQL ↔ Vector Query Routing",
      "Chunking Strategies",
      "Embedding Lifecycle & Reindexing",
      "Databricks Vector Search",
      "Context Assembly & Prompt Orchestration",
    ],
  },
  {
    id: "llm",
